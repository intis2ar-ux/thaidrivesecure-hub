...
export const mockApplications: Application[] = [
  { id: "25-001", status: "pending", submissionDate: new Date("2025-01-15"), customerName: "Ahmad Razak", customerPhone: "0111234567", customerEmail: "ahmad@email.com", destination: "Hatyai", travelDate: new Date("2025-02-10"), passengerCount: 4, vehicleType: "sedan", packageType: "compulsory", addons: ["TM2/3", "TDAC"], deliveryOption: "takeaway", totalPrice: 55 },
  { id: "25-002", status: "verified", submissionDate: new Date("2025-01-14"), customerName: "Siti Aminah", customerPhone: "0129876543", customerEmail: "siti@email.com", destination: "Bangkok", travelDate: new Date("2025-02-15"), passengerCount: 2, vehicleType: "mpv", packageType: "compulsory_voluntary", addons: ["TM2/3"], deliveryOption: "email_pdf", totalPrice: 85 },
  { id: "25-003", status: "approved", submissionDate: new Date("2025-01-13"), customerName: "Raj Kumar", customerPhone: "0135551234", customerEmail: "raj@email.com", destination: "Hatyai", travelDate: new Date("2025-02-20"), passengerCount: 3, vehicleType: "sedan", packageType: "compulsory", addons: ["TDAC"], deliveryOption: "shipping", deliveryTrackingId: "MY1234567890", totalPrice: 47 },
  { id: "25-004", status: "rejected", submissionDate: new Date("2025-01-12"), customerName: "Lim Wei Ming", customerPhone: "0147778888", customerEmail: "weiming@email.com", destination: "Phuket", travelDate: new Date("2025-03-01"), passengerCount: 5, vehicleType: "pickup_suv", packageType: "compulsory_voluntary", addons: ["TM2/3", "TDAC"], deliveryOption: "takeaway", totalPrice: 120 },
  { id: "25-005", status: "completed", submissionDate: new Date("2025-01-11"), customerName: "Nurul Huda", customerPhone: "0159991111", customerEmail: "nurul@email.com", destination: "Hatyai", travelDate: new Date("2025-01-25"), passengerCount: 2, vehicleType: "motorcycle", packageType: "compulsory", addons: [], deliveryOption: "email_pdf", totalPrice: 25 },
  { id: "25-006", status: "pending", submissionDate: new Date("2025-01-16"), customerName: "Tan Ah Kow", customerPhone: "0162223333", customerEmail: "ahkow@email.com", destination: "Bangkok", travelDate: new Date("2025-02-28"), passengerCount: 4, vehicleType: "sedan", packageType: "compulsory", addons: ["TM2/3"], deliveryOption: "takeaway", totalPrice: 47 },
  { id: "25-007", status: "verified", submissionDate: new Date("2025-01-16"), customerName: "Fatimah Zahra", customerPhone: "0173334444", customerEmail: "fatimah@email.com", destination: "Hatyai", travelDate: new Date("2025-03-05"), passengerCount: 3, vehicleType: "mpv", packageType: "compulsory_voluntary", addons: ["TDAC"], deliveryOption: "shipping", totalPrice: 95 },
  { id: "25-008", status: "pending", submissionDate: new Date("2025-01-17"), customerName: "Muthu Samy", customerPhone: "0184445555", customerEmail: "muthu@email.com", destination: "Phuket", travelDate: new Date("2025-03-10"), passengerCount: 6, vehicleType: "pickup_suv", packageType: "compulsory", addons: ["TM2/3", "TDAC"], deliveryOption: "email_pdf", totalPrice: 75 },
  { id: "25-009", status: "approved", submissionDate: new Date("2025-01-18"), customerName: "Wong Mei Ling", customerPhone: "0195556666", customerEmail: "meiling@email.com", destination: "Hatyai", travelDate: new Date("2025-03-15"), passengerCount: 2, vehicleType: "sedan", packageType: "compulsory", addons: [], deliveryOption: "takeaway", totalPrice: 39 },
  { id: "25-010", status: "verified", submissionDate: new Date("2025-01-18"), customerName: "Zainab Ibrahim", customerPhone: "0106667777", customerEmail: "zainab@email.com", destination: "Bangkok", travelDate: new Date("2025-03-20"), passengerCount: 4, vehicleType: "mpv", packageType: "compulsory_voluntary", addons: ["TM2/3", "TDAC"], deliveryOption: "shipping", totalPrice: 110 },
];
