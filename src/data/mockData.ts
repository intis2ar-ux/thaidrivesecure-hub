...
export const mockApplications: Application[] = [
  { id: "25-001", status: "pending", createdAt: new Date("2025-01-15"), name: "Ahmad Razak", phone: "0111234567", where: "Hatyai", when: "Monday", passengers: 4, vehicleType: "Sedan", packages: ["compulsory", "TM2/3", "TDAC"], deliveryMethod: "takeaway", totalPrice: 55 },
  { id: "25-002", status: "approved", createdAt: new Date("2025-01-14"), name: "Siti Aminah", phone: "0129876543", where: "Bangkok", when: "Tuesday", passengers: 2, vehicleType: "MPV", packages: ["compulsory", "TM2/3"], deliveryMethod: "email_pdf", totalPrice: 85 },
  { id: "25-003", status: "approved", createdAt: new Date("2025-01-13"), name: "Raj Kumar", phone: "0135551234", where: "Hatyai", when: "Wednesday", passengers: 3, vehicleType: "Sedan", packages: ["compulsory", "TDAC"], deliveryMethod: "shipping", totalPrice: 47 },
  { id: "25-004", status: "rejected", createdAt: new Date("2025-01-12"), name: "Lim Wei Ming", phone: "0147778888", where: "Phuket", when: "Thursday", passengers: 5, vehicleType: "Pickup/SUV", packages: ["compulsory", "TM2/3", "TDAC"], deliveryMethod: "takeaway", totalPrice: 120 },
  { id: "25-005", status: "approved", createdAt: new Date("2025-01-11"), name: "Nurul Huda", phone: "0159991111", where: "Hatyai", when: "Friday", passengers: 2, vehicleType: "Motorcycle", packages: ["compulsory"], deliveryMethod: "email_pdf", totalPrice: 25 },
  { id: "25-006", status: "pending", createdAt: new Date("2025-01-16"), name: "Tan Ah Kow", phone: "0162223333", where: "Bangkok", when: "Saturday", passengers: 4, vehicleType: "Sedan", packages: ["compulsory", "TM2/3"], deliveryMethod: "takeaway", totalPrice: 47 },
  { id: "25-007", status: "pending", createdAt: new Date("2025-01-16"), name: "Fatimah Zahra", phone: "0173334444", where: "Hatyai", when: "Sunday", passengers: 3, vehicleType: "MPV", packages: ["compulsory", "TDAC"], deliveryMethod: "shipping", totalPrice: 95 },
  { id: "25-008", status: "pending", createdAt: new Date("2025-01-17"), name: "Muthu Samy", phone: "0184445555", where: "Phuket", when: "Monday", passengers: 6, vehicleType: "Pickup/SUV", packages: ["compulsory", "TM2/3", "TDAC"], deliveryMethod: "email_pdf", totalPrice: 75 },
  { id: "25-009", status: "approved", createdAt: new Date("2025-01-18"), name: "Wong Mei Ling", phone: "0195556666", where: "Hatyai", when: "Tuesday", passengers: 2, vehicleType: "Sedan", packages: ["compulsory"], deliveryMethod: "takeaway", totalPrice: 39 },
  { id: "25-010", status: "pending", createdAt: new Date("2025-01-18"), name: "Zainab Ibrahim", phone: "0106667777", where: "Bangkok", when: "Wednesday", passengers: 4, vehicleType: "MPV", packages: ["compulsory", "TM2/3", "TDAC"], deliveryMethod: "shipping", totalPrice: 110 },
];
